...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMWiggle : MonoBehaviour 
    {
        ...
        public virtual void StopWigglePosition()
        {
            transform.localPosition = _positionInternalProperties.initialValue;
            StopWiggle(ref PositionWiggleProperties);
        }

        public virtual void StopWiggleRotation()
        {
            transform.localEulerAngles = _rotationInternalProperties.initialValue;
            StopWiggle(ref RotationWiggleProperties);
        }

        public virtual void StopWiggleScale()
        {
            transform.localScale = _scaleInternalProperties.initialValue;
            StopWiggle(ref ScaleWiggleProperties);
        }
